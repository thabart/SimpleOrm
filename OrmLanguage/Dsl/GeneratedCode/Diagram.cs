...
[module: global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1506:AvoidExcessiveClassCoupling", Scope = "type", Target = "Company.OrmLanguage.OrmLanguageDiagram")]
...
namespace Company.OrmLanguage
{
	...
	[DslModeling::DomainObjectId("c3303623-5860-4dd8-9d94-f791d26e5e29")]
	public partial class OrmLanguageDiagram : DslDiagrams::Diagram
	{
		...
		private static global::System.ComponentModel.ToolboxItemFilterAttribute[] toolboxFilters = new global::System.ComponentModel.ToolboxItemFilterAttribute[] {
					new global::System.ComponentModel.ToolboxItemFilterAttribute(global::Company.OrmLanguage.OrmLanguageToolboxHelperBase.ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) };
		...
		{
			if(element is global::Company.OrmLanguage.EntityElement)
			{
				global::Company.OrmLanguage.EntityShape newShape = new global::Company.OrmLanguage.EntityShape(this.Partition);
		...
		protected override void InitializeShapeFields(global::System.Collections.Generic.IList<DslDiagrams::ShapeField> shapeFields)
		{
			...
			global::Company.OrmLanguage.EntityShape.DecoratorsInitialized += EntityShapeDecoratorMap.OnDecoratorsInitialized;
		}
		...
		/// </summary>
		public static readonly new global::System.Guid DomainClassId = new global::System.Guid(0xc3303623, 0x5860, 0x4dd8, 0x9d, 0x94, 0xf7, 0x91, 0xd2, 0x6e, 0x5e, 0x29);
		/// <summary>
		/// Constructor
		/// </summary>
		/// <param name="store">Store where new element is to be created.</param>
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public OrmLanguageDiagram(DslModeling::Store store, params DslModeling::PropertyAssignment[] propertyAssignments)
		...
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public OrmLanguageDiagram(DslModeling::Partition partition, params DslModeling::PropertyAssignment[] propertyAssignments)
...
namespace Company.OrmLanguage
{
		...
		internal sealed partial class FixUpDiagram : FixUpDiagramBase
		{
			...
			public override void ElementAdded(DslModeling::ElementAddedEventArgs e)
			{
				...
				if(childElement is global::Company.OrmLanguage.EntityElement)
				{
					parentElement = GetParentForEntityElement((global::Company.OrmLanguage.EntityElement)childElement);
				} else
				{
					parentElement = null;
				}
			...
			public static global::Company.OrmLanguage.SampleOrmModel GetParentForEntityElement( global::Company.OrmLanguage.EntityElement root )
			{
				// Segments 0 and 1
				global::Company.OrmLanguage.SampleOrmModel result = root.SampleOrmModel;
			...
			internal static void RolePlayerChanged(DslModeling::RolePlayerChangedEventArgs e, bool repaintOnly)
			{
				...
				if(typeof(global::Company.OrmLanguage.EntityHasProperties).IsAssignableFrom(e.DomainRelationship.ImplementationClass))
				{
					if(e.DomainRole.IsSource)
					{
						...
						global::System.Collections.IEnumerable elements = CompartmentItemAddRule.GetEntityElementForEntityShapePropertiesFromLastLink((global::Company.OrmLanguage.EntityHasProperties)e.ElementLink);
						CompartmentItemAddRule.UpdateCompartments(elements, typeof(global::Company.OrmLanguage.EntityShape), "Properties", repaintOnly);
					}
					else 
					{
