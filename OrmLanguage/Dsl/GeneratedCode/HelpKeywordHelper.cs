...
namespace Company.OrmLanguage
{
	...
	/// </remarks>
	public partial class OrmLanguageHelpKeywordHelper : OrmLanguageHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new OrmLanguageHelpKeywordHelper.
		/// </summary>
		protected OrmLanguageHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the OrmLanguageHelpKeywordHelper.
		/// </summary>
		public static OrmLanguageHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class OrmLanguageHelpKeywordHelperBase
	{
		...
		/// </summary>
		protected OrmLanguageHelpKeywordHelperBase()
			: base() { }
