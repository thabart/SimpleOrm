...
namespace Company.OrmLanguage
{
	...
	/// </remarks>
	public partial class OrmLanguageToolboxHelper : OrmLanguageToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new OrmLanguageToolboxHelper.
		/// </summary>
		public OrmLanguageToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class OrmLanguageToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify OrmLanguage toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "OrmLanguage.1.0";
		/// <summary>
		/// Toolbox item filter string used to identify EntityRelationShip connector tool.
		/// </summary>
		public const string EntityRelationShipFilterString = "EntityRelationShip.1.0";
		...
		/// </summary>
		protected OrmLanguageToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Company.OrmLanguage.OrmLanguageDomainModel.SingletonResourceManager.GetString("OrmLanguageToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			switch(itemId)
			{
				case "Company.OrmLanguage.EntityToolboxItem":
					// Add Entity shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.OrmLanguage.EntityToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"Company.OrmLanguage.OrmLanguageToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("OrmLanguageToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::Company.OrmLanguage.EntityElement.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.OrmLanguage.EntityRelationShipToolboxItem":

					// Add EntityRelationShip connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.OrmLanguage.EntityRelationShipToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"Company.OrmLanguage.OrmLanguageToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("OrmLanguageToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"EntityRelationShip", // F1 help keyword for the toolbox item.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Company.OrmLanguage.OrmLanguageDomainModel));
