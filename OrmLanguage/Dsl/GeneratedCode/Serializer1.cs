...
namespace Company.OrmLanguage
{
	...
	public partial class EntrySerializer : DslModeling::DomainClassXmlSerializer
	{
		...
		#region Read Methods
		/// <summary>
		/// Entry is abstract and cannot be instantiated, so this method throws NotSupportedException.
		/// </summary>
		/// <remarks>
		/// When this method is called, caller guarantees that the passed-in XML reader is positioned at the open XML tag
		...
		protected override void ReadPropertiesFromAttributes(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlReader reader)
		{
			...
			if (!serializationContext.Result.Failed)
			{
				string attribType = OrmLanguageSerializationHelper.Instance.ReadAttribute(serializationContext, element, reader, "type");
				if (attribType != null)
				{
					global::System.TypeCode valueOfType;
					if (DslModeling::SerializationUtilities.TryGetValue<global::System.TypeCode>(serializationContext, attribType, out valueOfType))
					{
						instanceOfEntry.Type = valueOfType;
					}
					else
					{	// Invalid property value, ignored.
						OrmLanguageSerializationBehaviorSerializationMessages.IgnoredPropertyValue(serializationContext, reader, "type", typeof(global::System.TypeCode), attribType);
					}
				}
			}
		}
		...
		public override void WriteMoniker(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer, DslModeling::ModelElement sourceRolePlayer, DslModeling::DomainRelationshipXmlSerializer relSerializer)
		{
			// Instance of Entry cannot be monikerized.
			OrmLanguageSerializationBehaviorSerializationMessages.CannotMonikerizeElement(serializationContext, "Entry");
		}
		...
		protected override void WritePropertiesAsAttributes(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer)
		{
			...
			if (!serializationContext.Result.Failed)
			{
				global::System.TypeCode propValue = instanceOfEntry.Type;
				string serializedPropValue = DslModeling::SerializationUtilities.GetString<global::System.TypeCode>(serializationContext, propValue);
				if (!serializationContext.Result.Failed)
				{
					OrmLanguageSerializationHelper.Instance.WriteAttributeString(serializationContext, element, writer, "type", serializedPropValue);
				}
			}
		}
		#endregion
...
namespace Company.OrmLanguage
{
	...
	/// </summary>
	public sealed partial class PropertySerializer : EntrySerializer
	{
		#region Constructor
		/// <summary>
...
namespace Company.OrmLanguage
{
	...
	/// </summary>
	public sealed partial class ReferenceSerializer : EntrySerializer
	{
		#region Constructor
		/// <summary>
