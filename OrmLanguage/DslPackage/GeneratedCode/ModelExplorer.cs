...
namespace Company.OrmLanguage
{
	...
	/// </summary>
	internal partial class OrmLanguageExplorer : OrmLanguageExplorerBase
	{
		/// <summary>
		/// Constructs a new OrmLanguageExplorer.
		/// </summary>
		public OrmLanguageExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the OrmLanguageExplorerToolWindow.
	/// </summary>
	internal abstract class OrmLanguageExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new OrmLanguageExplorerBase.
		/// </summary>
		protected OrmLanguageExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.OrmLanguageExplorerMenu;
			}
		}
		...
		{
			get { return global::Company.OrmLanguage.SampleOrmModel.DomainClassId; }
		}
