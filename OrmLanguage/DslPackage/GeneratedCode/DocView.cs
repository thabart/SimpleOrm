...
namespace Company.OrmLanguage
{
	...
	/// </summary>
	internal partial class OrmLanguageDocView : OrmLanguageDocViewBase
	{
		/// <summary>
		/// Constructs a new OrmLanguageDocView.
		/// </summary>
		public OrmLanguageDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class OrmLanguageDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new OrmLanguageDocView.
		/// </summary>
		...
		protected override bool LoadView()
		{
			...
			OrmLanguageDocDataBase docData = this.DocData as OrmLanguageDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for OrmLanguageDocViewBase should be an OrmLanguageDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.OrmLanguage.OrmLanguageDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.OrmLanguage.OrmLanguageDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.OrmLanguage.OrmLanguageToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.OrmLanguage.OrmLanguageToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.OrmLanguageDiagramMenu;
			}
		}
			...
			if(global::Company.OrmLanguage.OrmLanguageHelpKeywordHelper.Instance != null)
			{
				...
				if(selectedElement != null)
				{
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.OrmLanguage.OrmLanguageHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
