...
namespace Company.OrmLanguage
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.OrmLanguageEditorFactoryId)]
	internal partial class OrmLanguageEditorFactory : OrmLanguageEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new OrmLanguageEditorFactory.
		/// </summary>
		public OrmLanguageEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class OrmLanguageEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected OrmLanguageEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new OrmLanguageDocData(this.ServiceProvider, typeof(OrmLanguageEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new OrmLanguageDocView(docData, this.ServiceProvider);
		}
	}
}
